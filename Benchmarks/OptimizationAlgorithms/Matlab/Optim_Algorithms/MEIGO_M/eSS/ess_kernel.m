...
% Last Update: 30/05/2014 -- fixed bugs in ess_kernel and ess_local_filters
...
%     vers='eSS R2014A  IIM-CSIC, Vigo, Spain';
%     fprintf('%-9s %s\n','Version:',  vers);
% end

fprintf('\n');
fprintf('------------------------------------------------------------------------------ \n');
fprintf(' eSS R2014A - Enhanced Scatter Search    \n');
...
if local_finish & isempty(ndata) & strcmp(local_finish,'n2fb') | strcmp(local_finish,'dn2fb')
    n_out_f=nargout(problem.f);
    if n_out_f<3
        fprintf('%s requires 3 output arguments \n',local_solver);
        fprintf('EXITING \n');
