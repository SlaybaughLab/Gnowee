...
function varargout = tsp_ga(varargin)    
    ...
    defaultConfig.convTol     = 1E-2;
    defaultConfig.stallLimit  = 300;
    defaultConfig.optimum     = 0; 
    ...
    convTol     = configStruct.convTol;
    stallLimit  = configStruct.stallLimit;
    optimum     = configStruct.optimum;
    ...
    while iter <= numIter && (globalMin-optimum)/optimum > convTol
        ...
        %Test stall limit
        if iter > stallLimit
            if globalMin == distHistory(iter-stallLimit)
                break
            end
        end
    ...
    if nargout
        resultStruct = struct( ...
            ...
            'optRoute',    optRoute, ...
            'minDist',     minDist, ...
            'fevalHist',   fevalHistory, ...
            'distHist',    distHistory);
